<script>
	...
	// Derived Palette
	// Normal: HSL generation
	// Nordlichter: #0D1B2A, #2EC4B6, #7209B7, #CBFF4D
	// Sportplatz: #4CAF50, #FFFFFF, #333333, #1982C4
	// Chinatown: #D32F2F, #FFD700, #2D3436, #F2F2F2
	// Miami: #F2F2F2 (Base), #FF91AF (Pink), #00E5FF (Blue), #FFB347 (Orange)

	let cBase_Final = $derived(
				...
				>
					{#each Array(detailLayers) as _, layer}
						...
						<g transform="translate({step}, {step})" opacity={opacityLayer}>
							<!-- Helle Parallelogramme (Base/Light) -->
							<path d="M1286.99 1284.99L1164.54 1370.99H704.002L826.458 1284.99H1286.99Z" fill={cBase_Final} />
							<path d="M582.992 582.991L460.536 668.991H0.00170898L122.458 582.991H582.992Z" fill={cLight_Final} />
							<path d="M120.602 1280.99L243.058 1366.99H703.592L581.136 1280.99H120.602Z" fill={cBase_Final} />
							<path d="M824.602 582.991L947.058 668.991H1407.59L1285.14 582.991H824.602Z" fill={cLight_Final} />

							<!-- Dunkle Parallelogramme (Dark) -->
							<path d="M1407.59 735.001L1285.14 821.001H824.603L947.06 735.001H1407.59Z" fill={cDark_Final} />
							<path d="M703.594 33.0007L581.137 119.001H120.603L243.06 33.0007H703.594Z" fill={cDark_Final} />
							<path d="M0 731.001L122.456 817.001H582.99L460.534 731.001H0Z" fill={cDark_Final} />
							<path d="M704 33.0007L826.456 119.001H1286.99L1164.53 33.0007H704Z" fill={cDark_Final} />

							<!-- Vertikale Parallelogramme (Accent/Mid) -->
							<path d="M824.594 1284.99L738.594 1162.53L738.594 702L824.594 824.456L824.594 1284.99Z" fill={cAccent_Final} />
							<path d="M120.594 582.991L34.5938 460.535L34.5938 0.000488281L120.594 122.457L120.594 582.991Z" fill={cAccent_Final} />
							<path d="M583 1280.99L669 1158.53L669 698L583 820.456L583 1280.99Z" fill={cMid_Final} />
							<path d="M1287 582.991L1373 460.535L1373 0.000488281L1287 122.457L1287 582.991Z" fill={cMid_Final} />

							<!-- Weitere vertikale Parallelogramme (Mid) -->
							<path d="M1372.59 1403.99L1286.59 1281.53L1286.59 821L1372.59 943.456L1372.59 1403.99Z" fill={cMid_Final} />
							<path d="M668.594 701.991L582.594 579.535L582.594 119L668.594 241.457L668.594 701.991Z" fill={cMid_Final} />
							<path d="M35 1399.99L121 1277.53L121 817L35 939.456L35 1399.99Z" fill={cAccent_Final} />
							<path d="M739 701.991L825 579.535L825 119L739 241.457L739 701.991Z" fill={cMid_Final} />
						</g>
					{/each}
